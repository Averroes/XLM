...
For Chinese, Japanese and Thai you will need a special tokenizer that you can install using the commands below. For all other languages, the data will be tokenized with Moses scripts.
...
# Japanese - Follow steps in http://www.phontron.com/kytea/
```
